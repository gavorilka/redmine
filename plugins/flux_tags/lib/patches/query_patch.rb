  ...
  module QueryPatch
    ...
    module InstanceMethods
      ...
      def initialize_issue_tags_filter
        return unless FluxTags.setting?(:active_issue_tags) && User.current.allowed_to?(:view_issue_tags, project, global: true)
      ...
      def initialize_time_entry_tags_filter
        add_available_filter 'time_entry.tags',
                             type: :list_optional,
                             name: l('label_attribute_of_time_entry', name: l(:field_tags)),
                             values: -> { available_tag_values TimeEntry }
      end
